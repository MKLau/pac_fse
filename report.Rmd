...
```{r results_wordclouds, fig.dim = c(6, 6), echo = FALSE, message=FALSE, warning=FALSE}
...
```{r results_wordclouds_lo, fig.dim = c(6, 6), echo = FALSE, message=FALSE, warning=FALSE}
...
```{r results_similarity, fig.dim = c(7, 7), echo = FALSE}
