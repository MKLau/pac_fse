...
```{r results_wordclouds, echo = FALSE}
...
wordcloud(wc.labs, wc.scfs.program, min.freq = 1, random.order = F, scale = c(1, 0.1), rot.per = 0)

layout(matrix(c(1, 2), nrow=2), heights=c(1, 4))
par(mar=rep(0, 4))
plot.new()
text(x=0.5, y=0.5, "SCFS Courses", cex = 2)
wordcloud(wc.labs, wc.scfs.courses, min.freq = 1, random.order = F, scale = c(1, 0.1), rot.per = 0)

layout(matrix(c(1, 2), nrow=2), heights=c(1, 4))
par(mar=rep(0, 4))
plot.new()
text(x=0.5, y=0.5, "CTAHR Program", cex = 2)
wordcloud(wc.labs, wc.ctahr.program, min.freq = 1, random.order = F, scale = c(1, 0.1), rot.per = 0)

layout(matrix(c(1, 2), nrow=2), heights=c(1, 4))
par(mar=rep(0, 4))
plot.new()
text(x=0.5, y=0.5, "CTAHR Courses", cex = 2)
wordcloud(wc.labs, wc.ctahr.courses, min.freq = 1, random.order = F, scale = c(1, 0.1), rot.per = 0)

layout(matrix(c(1, 2), nrow=2), heights=c(1, 4))
par(mar=rep(0, 4))
plot.new()
text(x=0.5, y=0.5, "USP Program", cex = 2)
wordcloud(wc.labs, wc.usp.program, min.freq = 1, random.order = F, scale = c(1, 0.1), rot.per = 0)

layout(matrix(c(1, 2), nrow=2), heights=c(1, 4))
par(mar=rep(0, 4))
plot.new()
text(x=0.5, y=0.5, "USP Courses", cex = 2)
wordcloud(wc.labs, wc.usp.courses, min.freq = 1, random.order = F, scale = c(1, 0.1), rot.per = 0)
...
heatmap(abs(hm.align - max(hm.align)), Colv = NA, Rowv = NA, col = terrain.colors(256))
